...
(function() {
  ...
  var codeFromUrl, controllerScreen, errorMsg, gameCodeInput, joinBtn, joinGame, joinScreen, joystickActive, joystickCenter, joystickContainer, joystickKnob, maxDistance, resetJoystick, shootBtn, socket, updateJoystick, urlParams;
  ...
  if (codeFromUrl) {
    ...
    socket.on('connect', function() {
      ...
      return socket.emit('join-game', codeFromUrl.toUpperCase());
    });
  }
